...
// Now, lets try the higher order function: calculator()
...
// Invoke the apply discount function (the outer function)
applyDiscount(catProducts, applyPercentDiscount, .50)
